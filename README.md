...
This repository contains an implementation of the LeNet-5 architecture with batch normalization applied after each convolutional and fully connected layer. The implementation is done using Python and PyTorch. It uses [uv](https://docs.astral.sh/uv/) as its package manager.
